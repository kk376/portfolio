...
{`       .----------------.
  ...
  return (
    <section id="system" className="py-20 md:py-24 border-b border-black/5 dark:border-white/10 bg-[#e8ebe6] dark:bg-[#0e0f0c] transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-14 gap-6">
          ...
          <div className="flex items-center gap-2 self-start lg:self-end">
            <button
              ...
              className={`px-5 py-2.5 rounded-full font-sans text-xs font-bold transition-all active:scale-95 ${
                activeTab === 'specs'
        ...
        {activeTab === 'specs' ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="rounded-[24px] border border-black/5 dark:border-white/10 bg-white dark:bg-[#191b16] p-6 shadow-sm flex flex-col justify-between hover:border-[#9fe870] transition-all">
              <div>
                <div className="flex items-center justify-between border-b border-black/5 dark:border-white/10 pb-3 mb-4 font-mono text-xs">
                  <span className="flex items-center gap-2 text-[#0e0f0c] dark:text-[#f4f6f2] font-bold">
                    <Monitor className="w-4 h-4 text-[#163300] dark:text-[#9fe870]" />
                    SPEC 01 // PLATFORM
                  </span>
                  <span className="text-[#868685]">OS</span>
                </div>
                <div className="font-display text-2xl font-black text-[#0e0f0c] dark:text-[#f4f6f2] mb-1">{SYSTEM_SPECS.os}</div>
                <div className="font-mono text-xs text-[#454745] dark:text-[#b5b8b2]">{SYSTEM_SPECS.kernel}</div>
              </div>
              <div className="mt-5 pt-3 border-t border-black/5 dark:border-white/5 font-mono text-[11px] text-[#868685]">
            ...
            <div className="rounded-[24px] border border-black/5 dark:border-white/10 bg-white dark:bg-[#191b16] p-6 shadow-sm flex flex-col justify-between hover:border-[#9fe870] transition-all">
              <div>
                <div className="flex items-center justify-between border-b border-black/5 dark:border-white/10 pb-3 mb-4 font-mono text-xs">
                  <span className="flex items-center gap-2 text-[#0e0f0c] dark:text-[#f4f6f2] font-bold">
                    <Cpu className="w-4 h-4 text-[#163300] dark:text-[#9fe870]" />
                    SPEC 02 // COMPUTE
                  </span>
                  <span className="text-[#868685]">CPU</span>
                </div>
                <div className="font-display text-2xl font-black text-[#0e0f0c] dark:text-[#f4f6f2] mb-1">{SYSTEM_SPECS.cpu}</div>
                <div className="font-mono text-xs text-[#454745] dark:text-[#b5b8b2]">6 Cores / 12 Threads (Zen 3)</div>
              </div>
              <div className="mt-5 pt-3 border-t border-black/5 dark:border-white/5 font-mono text-[11px] text-[#868685]">
                Architecture: x86_64
              </div>
            ...
            <div className="rounded-[24px] border border-black/5 dark:border-white/10 bg-white dark:bg-[#191b16] p-6 shadow-sm flex flex-col justify-between hover:border-[#9fe870] transition-all">
              <div>
                <div className="flex items-center justify-between border-b border-black/5 dark:border-white/10 pb-3 mb-4 font-mono text-xs">
                  ...
                  <span className="text-[#868685]">GPU</span>
                </div>
                <div className="font-display text-2xl font-black text-[#0e0f0c] dark:text-[#f4f6f2] mb-1">Hybrid MUXless GPU</div>
                <div className="font-mono text-xs text-[#454745] dark:text-[#b5b8b2]">{SYSTEM_SPECS.gpu}</div>
              </div>
              <div className="mt-5 pt-3 border-t border-black/5 dark:border-white/5 font-mono text-[11px] text-[#868685]">
                Compositor: Wayland
              </div>
            ...
            <div className="rounded-[24px] border border-black/5 dark:border-white/10 bg-white dark:bg-[#191b16] p-6 shadow-sm flex flex-col justify-between hover:border-[#9fe870] transition-all">
              <div>
                <div className="flex items-center justify-between border-b border-black/5 dark:border-white/10 pb-3 mb-4 font-mono text-xs">
                  <span className="flex items-center gap-2 text-[#0e0f0c] dark:text-[#f4f6f2] font-bold">
                    <HardDrive className="w-4 h-4 text-[#163300] dark:text-[#9fe870]" />
                    SPEC 04 // MEMORY
                  </span>
                  <span className="text-[#868685]">RAM</span>
                </div>
                <div className="font-display text-2xl font-black text-[#0e0f0c] dark:text-[#f4f6f2] mb-1">{SYSTEM_SPECS.memory}</div>
                <div className="font-mono text-xs text-[#454745] dark:text-[#b5b8b2]">System Uptime: {SYSTEM_SPECS.uptime}</div>
              </div>
              <div className="mt-5 pt-3 border-t border-black/5 dark:border-white/5 font-mono text-[11px] text-[#868685]">
            ...
            <div className="rounded-[24px] border border-black/5 dark:border-white/10 bg-white dark:bg-[#191b16] p-6 shadow-sm flex flex-col justify-between hover:border-[#9fe870] transition-all">
              <div>
                <div className="flex items-center justify-between border-b border-black/5 dark:border-white/10 pb-3 mb-4 font-mono text-xs">
                  <span className="flex items-center gap-2 text-[#0e0f0c] dark:text-[#f4f6f2] font-bold">
                    <Terminal className="w-4 h-4 text-[#163300] dark:text-[#9fe870]" />
                    SPEC 05 // ENVIRONMENT
                  </span>
                  <span className="text-[#868685]">SHELL</span>
                </div>
                <div className="font-display text-2xl font-black text-[#0e0f0c] dark:text-[#f4f6f2] mb-1">{SYSTEM_SPECS.shell}</div>
                <div className="font-mono text-xs text-[#454745] dark:text-[#b5b8b2]">{SYSTEM_SPECS.terminal}</div>
              </div>
              <div className="mt-5 pt-3 border-t border-black/5 dark:border-white/5 font-mono text-[11px] text-[#868685]">
            ...
            <div className="rounded-[24px] border border-black/5 dark:border-white/10 bg-white dark:bg-[#191b16] p-6 shadow-sm flex flex-col justify-between hover:border-[#9fe870] transition-all">
              <div>
                <div className="flex items-center justify-between border-b border-black/5 dark:border-white/10 pb-3 mb-4 font-mono text-xs">
                  <span className="flex items-center gap-2 text-[#0e0f0c] dark:text-[#f4f6f2] font-bold">
                    <Info className="w-4 h-4 text-[#163300] dark:text-[#9fe870]" />
                    SPEC 06 // TOOLCHAIN
                  </span>
                  <span className="text-[#868685]">IDE</span>
                </div>
                <div className="font-display text-2xl font-black text-[#0e0f0c] dark:text-[#f4f6f2] mb-1">{SYSTEM_SPECS.editor}</div>
                <div className="font-mono text-xs text-[#454745] dark:text-[#b5b8b2]">Rust 1.85 / GCC 15 / Node 22</div>
              </div>

              <button
                onClick={copySpecs}
                className="mt-5 pt-3 border-t border-black/5 dark:border-white/5 inline-flex items-center justify-between font-mono text-xs font-bold text-[#0e0f0c] dark:text-[#f4f6f2] hover:text-[#163300] dark:hover:text-[#9fe870] transition-colors"
              >
                <span>{copied ? 'Specs copied to clipboard' : 'Copy specification text'}</span>
                {copied ? <Check className="w-4 h-4 text-[#2ead4b] stroke-[2.5]" /> : <Copy className="w-4 h-4" />}
              </button>
            </div>
          </div>
        ) : (
          /* Wise Dark Code Well Terminal */
          <div className="rounded-[24px] border border-white/10 bg-[#0e0f0c] text-white shadow-xl overflow-hidden">
            {/* Window header bar */}
            <div className="flex items-center justify-between px-6 py-3.5 border-b border-white/10 bg-[#191b16]">
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-red-500/80 inline-block" />
                <span className="w-3 h-3 rounded-full bg-yellow-500/80 inline-block" />
                <span className="w-3 h-3 rounded-full bg-green-500/80 inline-block" />
                <span className="font-mono text-xs text-[#b5b8b2] ml-2">
              ...
              <div className="flex items-center gap-2">
                {['kkfetch', 'upstream', 'projects', 'clear'].map((cmd) => (
                  <button
                    ...
                    className="px-3 py-1 rounded-full bg-white/10 hover:bg-[#9fe870] hover:text-[#0e0f0c] text-neutral-300 text-[11px] font-mono font-semibold transition-colors"
                  >
                    {cmd}
                  </button>
                ))}
            ...
            <div
              ...
              className="p-6 h-80 overflow-y-auto space-y-4 font-mono text-xs bg-[#0e0f0c]"
            >
              {history.map((item, idx) => (
                <div key={idx} className="space-y-1.5">
                  <div className="flex items-center gap-2 text-neutral-400">
                    <span className="text-[#9fe870] font-bold">kk376@victus</span>
                    <span className="text-neutral-500">:</span>
                    <span className="text-[#cdffad]">~</span>
            ...
            <div className="px-6 py-3 border-t border-white/5 text-[11px] font-mono text-[#868685] flex items-center justify-between bg-[#191b16]">
              <span>Press Enter to execute</span>
              <span className="text-[#9fe870] font-bold">Isolated Viewport (No Page Jump)</span>
            </div>
          </div>
        )}
      </div>
