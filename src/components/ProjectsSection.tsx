...
export const ProjectsSection: React.FC = () => {
  const getAccentStyles = (color: string) => {
    switch (color) {
      case 'pink':
        return {
          border: 'border-pink-300/80 dark:border-pink-500/30 hover:border-pink-500 dark:hover:border-pink-400',
          shadow: 'hover:shadow-pink-500/10 dark:hover:shadow-pink-500/15',
          badge: 'bg-pink-50 text-pink-700 border-pink-200 dark:bg-pink-500/15 dark:text-pink-300 dark:border-pink-500/30',
          metric: 'text-pink-700 bg-pink-50 dark:text-pink-300 dark:bg-pink-500/15',
          gradient: 'from-pink-500 to-rose-500',
        };
      case 'violet':
        return {
          border: 'border-purple-300/80 dark:border-purple-500/30 hover:border-purple-500 dark:hover:border-purple-400',
          shadow: 'hover:shadow-purple-500/10 dark:hover:shadow-purple-500/15',
          ...
          metric: 'text-purple-700 bg-purple-50 dark:text-purple-300 dark:bg-purple-500/15',
          gradient: 'from-purple-500 to-indigo-500',
        };
      case 'cyan':
        return {
          border: 'border-cyan-300/80 dark:border-cyan-500/30 hover:border-cyan-500 dark:hover:border-cyan-400',
          shadow: 'hover:shadow-cyan-500/10 dark:hover:shadow-cyan-500/15',
          badge: 'bg-cyan-50 text-cyan-700 border-cyan-200 dark:bg-cyan-500/15 dark:text-cyan-300 dark:border-cyan-500/30',
          metric: 'text-cyan-700 bg-cyan-50 dark:text-cyan-300 dark:bg-cyan-500/15',
          gradient: 'from-cyan-500 to-blue-500',
        };
      default:
        return {
          border: 'border-emerald-300/80 dark:border-emerald-500/30 hover:border-emerald-500 dark:hover:border-emerald-400',
          shadow: 'hover:shadow-emerald-500/10 dark:hover:shadow-emerald-500/15',
          ...
          metric: 'text-emerald-700 bg-emerald-50 dark:text-emerald-300 dark:bg-emerald-500/15',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {FLAGSHIP_PROJECTS.map((project) => {
            ...
            return (
              <div
                key={project.id}
                className={`p-6 rounded-2xl bg-white dark:bg-[#0b0d16] border ${styles.border} ${styles.shadow} transition-all duration-300 shadow-sm hover:shadow-lg dark:shadow-xl flex flex-col justify-between relative overflow-hidden group`}
              >
