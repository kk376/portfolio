...
export const Hero: React.FC = () => {
  return (
    <section id="about" className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
      ...
      <div className="absolute top-20 left-1/4 w-[450px] h-[350px] bg-purple-500/10 dark:bg-purple-600/15 rounded-full blur-[130px] pointer-events-none" />
      <div className="absolute top-36 right-1/4 w-[400px] h-[300px] bg-pink-500/10 dark:bg-pink-600/15 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute top-60 left-1/3 w-[500px] h-[280px] bg-cyan-400/10 dark:bg-cyan-500/15 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-12">
          ...
          <div className="lg:col-span-7 space-y-6">
            {/* Status Pill */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-pink-500/10 dark:bg-white/[0.04] border border-pink-500/30 text-pink-600 dark:text-pink-300 text-xs font-medium shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              <a
                href="#upstream"
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 hover:from-pink-600 hover:via-purple-600 hover:to-cyan-600 text-white font-semibold text-xs font-mono transition-all shadow-md shadow-purple-500/20 hover:shadow-lg hover:shadow-purple-500/30 flex items-center gap-2"
              >
              ...
              <a
                href="#skills"
                className="px-5 py-2.5 rounded-xl bg-white dark:bg-white/[0.05] hover:bg-slate-100 dark:hover:bg-white/[0.09] text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-white/[0.1] text-xs font-semibold font-mono transition-all flex items-center gap-2 shadow-sm dark:shadow-none"
              >
              ...
              <a
                ...
                className="p-2.5 rounded-xl bg-white dark:bg-white/[0.04] hover:bg-slate-100 dark:hover:bg-white/[0.08] text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white border border-slate-200 dark:border-white/[0.08] transition-all shadow-sm dark:shadow-none"
                title="GitHub"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 rounded-xl bg-white dark:bg-white/[0.04] hover:bg-slate-100 dark:hover:bg-white/[0.08] text-slate-600 hover:text-purple-600 dark:text-slate-300 dark:hover:text-white border border-slate-200 dark:border-white/[0.08] transition-all shadow-sm dark:shadow-none"
                title="LinkedIn"
              >
          ...
          <div className="lg:col-span-5">
            <div className="relative group">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-pink-500 via-purple-500 via-cyan-400 to-emerald-400 rounded-3xl blur-md opacity-40 dark:opacity-60 group-hover:opacity-75 dark:group-hover:opacity-90 transition-opacity duration-300" />

              <div className="relative rounded-2xl bg-white dark:bg-[#0c0e17] border border-slate-200 dark:border-white/[0.12] p-6 shadow-xl dark:shadow-2xl space-y-5">
                {/* Photo & Identity row */}
                ...
                <div className="grid grid-cols-2 gap-2.5 font-mono text-xs">
                  <div className="p-2.5 rounded-lg bg-slate-50 dark:bg-white/[0.03] border border-slate-200/80 dark:border-white/[0.06]">
                ...
                {/* Honest quote block */}
                <div className="p-3 rounded-xl bg-purple-50 dark:bg-gradient-to-r dark:from-purple-500/10 dark:via-pink-500/10 dark:to-cyan-500/10 border border-purple-200 dark:border-purple-500/20 text-xs text-slate-700 dark:text-slate-300 leading-relaxed font-sans">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5 pt-6 border-t border-slate-200 dark:border-white/[0.08]">
          <div className="p-4 rounded-xl bg-white dark:bg-white/[0.02] border border-cyan-500/30 dark:border-cyan-500/20 hover:border-cyan-500/50 dark:hover:border-cyan-500/40 shadow-sm dark:shadow-none transition-colors">
          ...
          <div className="p-4 rounded-xl bg-white dark:bg-white/[0.02] border border-pink-500/30 dark:border-pink-500/20 hover:border-pink-500/50 dark:hover:border-pink-500/40 shadow-sm dark:shadow-none transition-colors">
          ...
          <div className="p-4 rounded-xl bg-white dark:bg-white/[0.02] border border-purple-500/30 dark:border-purple-500/20 hover:border-purple-500/50 dark:hover:border-purple-500/40 shadow-sm dark:shadow-none transition-colors">
          ...
          <div className="p-4 rounded-xl bg-white dark:bg-white/[0.02] border border-emerald-500/30 dark:border-emerald-500/20 hover:border-emerald-500/50 dark:hover:border-emerald-500/40 shadow-sm dark:shadow-none transition-colors">
