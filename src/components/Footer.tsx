        ...
        <div className="flex items-center gap-4">
          ...
          {onOpenShortcuts && (
            <button
              ...
              className="group flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-mono bg-white dark:bg-[#252536] border border-slate-200 dark:border-white/10 text-slate-500 hover:text-[#FF4C60] hover:border-[#FF4C60]/40 transition-all shadow-xs active:scale-95 cursor-pointer"
            >
              <Command className="w-3.5 h-3.5 text-[#FF4C60] group-hover:scale-110 transition-transform duration-200" />
              <kbd className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-[#181824] border border-slate-200 dark:border-white/10 text-[10px] font-bold text-slate-700 dark:text-slate-300 group-hover:text-[#FF4C60] transition-colors">
                ?
              </kbd>
              <span className="hidden sm:inline text-[11px] font-medium text-slate-600 dark:text-slate-400 group-hover:text-[#FF4C60] transition-colors">
                Shortcuts
              </span>
            </button>
          )}
