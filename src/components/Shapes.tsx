  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0 opacity-60 dark:opacity-40 select-none">
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <circle cx="16" cy="16" r="13" stroke="var(--accent-primary)" strokeWidth="3" strokeDasharray="4 4" />
      </svg>
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <path d="M12 2L22 20H2L12 2Z" stroke="var(--accent-secondary)" strokeWidth="3" strokeLinejoin="round" />
      </svg>

      {/* Tri-color Dot Cluster */}
      <div
        className="absolute bottom-36 right-[14%] flex gap-2 animate-float"
        style={{ animationDelay: '1.5s' }}
      >
        <span className="w-3 h-3 rounded-full bg-[var(--accent-peach)]" />
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <circle cx="13" cy="13" r="10" stroke="var(--accent-secondary)" strokeWidth="3" />
      </svg>
    </div>
  );
};
