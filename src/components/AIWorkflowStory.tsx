...
export const AIWorkflowStory: React.FC = () => {
  return (
    <section className="py-20 border-t border-white/[0.08] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-purple-600/10 rounded-full blur-[140px] pointer-events-none" />

      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-[#0e101c] via-[#090b14] to-[#0d0f1a] border border-purple-500/30 shadow-2xl relative overflow-hidden">
          ...
          <div className="max-w-3xl mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-pink-500/10 border border-pink-500/30 text-pink-300 text-xs font-mono font-semibold uppercase tracking-wider mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="p-5 rounded-xl bg-white/[0.03] border border-pink-500/20 hover:border-pink-500/40 transition-colors space-y-2">
              <div className="w-9 h-9 rounded-lg bg-pink-500/10 border border-pink-500/30 flex items-center justify-center text-pink-400 mb-3">
                <Terminal className="w-4 h-4" />
              </div>
              <h3 className="text-base font-bold text-white">Curiosity & Problem Spotting</h3>
            ...
            <div className="p-5 rounded-xl bg-white/[0.03] border border-cyan-500/20 hover:border-cyan-500/40 transition-colors space-y-2">
              ...
              <h3 className="text-base font-bold text-white">Directing AI Architecture</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                I guide the AI step by step, steering implementation decisions, refusing swallowed errors, and demanding strict unit tests.
              </p>
            </div>

            <div className="p-5 rounded-xl bg-white/[0.03] border border-emerald-500/20 hover:border-emerald-500/40 transition-colors space-y-2">
              ...
              <h3 className="text-base font-bold text-white">Upstream Transparency</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
